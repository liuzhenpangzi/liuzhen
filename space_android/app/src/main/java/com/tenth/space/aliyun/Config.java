...
public class Config {
   ...
   // public static final String endpointExtra = "http://maomaojiang.oss-cn-shenzhen.aliyuncs.com/";
    public static final String endpointExtra = "http://10thspace1.oss-cn-shenzhen.aliyuncs.com/";
   // public static String pictrueUrl = "http://tenth.oss-cn-shenzhen.aliyuncs.com/" + Config.livePicsPath;//私有图片路径
    public static String pictrueUrl = "http://10thspace2.oss-cn-shenzhen.aliyuncs.com/" + Config.livePicsPath;//私有图片路径
    public static final String bucketName = "10thspace1";//"maomaojiang";//权限为共有
    public static final String privateBucketName = "10thspace2";//"tenth";//权限为私有的
    ...
    public  static  String SERVER_TYPE="normal";//test表示测试服务器
